...
ffi.cdef[[
/* + BEGIN <mono/jit/jit.h> /usr/lib/pkgconfig/../../include/mono-2.0/mono/jit/jit.h */
/* ++ BEGIN <mono/metadata/appdomain.h> /usr/lib/pkgconfig/../../include/mono-2.0/mono/metadata/appdomain.h */
/* +++ BEGIN <mono/utils/mono-publib.h> /usr/lib/pkgconfig/../../include/mono-2.0/mono/utils/mono-publib.h */
...
/* +++ END <mono/utils/mono-publib.h> /usr/lib/pkgconfig/../../include/mono-2.0/mono/utils/mono-publib.h */
/* +++ BEGIN <mono/utils/mono-forward.h> /usr/lib/pkgconfig/../../include/mono-2.0/mono/utils/mono-forward.h */
typedef struct _MonoDomain MonoDomain;
typedef struct _MonoJitInfo MonoJitInfo;
/* +++ END <mono/utils/mono-forward.h> /usr/lib/pkgconfig/../../include/mono-2.0/mono/utils/mono-forward.h */
/* +++ BEGIN <mono/metadata/object.h> /usr/lib/pkgconfig/../../include/mono-2.0/mono/metadata/object.h */
/* ++++ BEGIN <mono/metadata/object-forward.h> /usr/lib/pkgconfig/../../include/mono-2.0/mono/metadata/object-forward.h */
...
/* ++++ END <mono/metadata/object-forward.h> /usr/lib/pkgconfig/../../include/mono-2.0/mono/metadata/object-forward.h */
/* ++++ BEGIN <mono/metadata/class.h> /usr/lib/pkgconfig/../../include/mono-2.0/mono/metadata/class.h */
/* +++++ BEGIN <mono/metadata/metadata.h> /usr/lib/pkgconfig/../../include/mono-2.0/mono/metadata/metadata.h */
/* ++++++ BEGIN <mono/metadata/blob.h> /usr/lib/pkgconfig/../../include/mono-2.0/mono/metadata/blob.h */
enum {
 MONO_TYPE_END = 0x00,
 MONO_TYPE_VOID = 0x01,
...
/* ++++++ END <mono/metadata/blob.h> /usr/lib/pkgconfig/../../include/mono-2.0/mono/metadata/blob.h */
/* ++++++ BEGIN <mono/metadata/row-indexes.h> /usr/lib/pkgconfig/../../include/mono-2.0/mono/metadata/row-indexes.h */
enum {
...
/* ++++++ END <mono/metadata/row-indexes.h> /usr/lib/pkgconfig/../../include/mono-2.0/mono/metadata/row-indexes.h */
/* ++++++ BEGIN <mono/metadata/image.h> /usr/lib/pkgconfig/../../include/mono-2.0/mono/metadata/image.h */
/* +++++++ BEGIN <stdio.h> /usr/include/stdio.h */
]] require 'ffi.req' 'c.stdio' ffi.cdef[[
/* +++++++ END <stdio.h> /usr/include/stdio.h */
/* +++++++ BEGIN <mono/utils/mono-error.h> /usr/lib/pkgconfig/../../include/mono-2.0/mono/utils/mono-error.h */
enum {
...
/* +++++++ END <mono/utils/mono-error.h> /usr/lib/pkgconfig/../../include/mono-2.0/mono/utils/mono-error.h */
...
/* ++++++ END <mono/metadata/image.h> /usr/lib/pkgconfig/../../include/mono-2.0/mono/metadata/image.h */
enum {
 MONO_EXCEPTION_CLAUSE_NONE,
 MONO_EXCEPTION_CLAUSE_FILTER,
 MONO_EXCEPTION_CLAUSE_FINALLY,
 MONO_EXCEPTION_CLAUSE_FAULT = 4
}; typedef int MonoExceptionEnum;
enum {
 MONO_CALL_DEFAULT,
 MONO_CALL_C,
 MONO_CALL_STDCALL,
 ...
 MONO_CALL_FASTCALL,
 MONO_CALL_VARARG
}; typedef int MonoCallConvention;
enum {
...
}; typedef int MonoMarshalVariant;
enum {
...
mono_type_to_unmanaged (MonoType *type, MonoMarshalSpec *mspec,
 ...
 uint32_t mono_metadata_decode_table_row_col (MonoImage *image, int table,
        int idx,
        unsigned int col);
/* +++++ END <mono/metadata/metadata.h> /usr/lib/pkgconfig/../../include/mono-2.0/mono/metadata/metadata.h */
/* +++++ BEGIN <mono/metadata/loader.h> /usr/lib/pkgconfig/../../include/mono-2.0/mono/metadata/loader.h */
...
/* +++++ END <mono/metadata/loader.h> /usr/lib/pkgconfig/../../include/mono-2.0/mono/metadata/loader.h */
...
}; typedef int MonoTypeNameFormat;
MonoClass *
...
/* ++++ END <mono/metadata/class.h> /usr/lib/pkgconfig/../../include/mono-2.0/mono/metadata/class.h */
...
/* +++ END <mono/metadata/object.h> /usr/lib/pkgconfig/../../include/mono-2.0/mono/metadata/object.h */
/* +++ BEGIN <mono/metadata/reflection.h> /usr/lib/pkgconfig/../../include/mono-2.0/mono/metadata/reflection.h */
...
}; typedef int MonoResolveTokenError;
...
/* +++ END <mono/metadata/reflection.h> /usr/lib/pkgconfig/../../include/mono-2.0/mono/metadata/reflection.h */
...
/* ++ END <mono/metadata/appdomain.h> /usr/lib/pkgconfig/../../include/mono-2.0/mono/metadata/appdomain.h */
 MonoDomain *
